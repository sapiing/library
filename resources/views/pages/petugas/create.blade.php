...
@section('content')
    <h4 class="py-3 mb-0">
        <span class="text-muted fw-light"><a href="{{ route('petugas') }}">Petugas /</a></span><span class="fw-medium"> Tambah
            petugas</span>
    </h4>
        ...
        <form action="{{ route('petugas.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-3">
                ...
                <div class="d-flex flex-column justify-content-center">
                    <h4 class="mb-1 mt-3">Menambah petugas</h4>
                    <p class="text-muted">Klik Tambah Untuk Menambah petugas</p>
                </div>
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="nama" placeholder="John Die"
                                    name="nama" aria-label="Nama petugas">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <div class="col"><label class="form-label" for="email">E-mail</label>
                                    <input type="text" class="form-control" id="email" placeholder="email@gmail.com"
                                        name="email" aria-label="Email petugas">
                                </div>
                            </div>
                            <div class="mb-3">
                                <div class="col">
                                    ...
                                    <div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="jenis_kelamin"
                                                id="laki_laki" value="Laki-laki" checked>
