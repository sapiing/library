...
@section('content')
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-3">
        ...
        <div class="d-flex flex-column justify-content-center">
            <h4 class="mb-1 mt-3">Tambah Petugas</h4>
            <p class="text-muted">Tambahikan Petugas Baru</p>
        </div>
        <div class="d-flex align-content-center flex-wrap gap-3">
            <button type="submit" onclick="window.location.href='{{ route('petugas.create') }}'"
                class="btn btn-primary">Tambah Petugas</button>
        </div>
                    ...
                    @if ($petugas->count() > 0)
                        @foreach ($petugas as $rs)
                            <tr>
                                ...
                                <td>
                                    <div class="">
                                        <form action="{{ route('petugas.edit', $rs->id) }}" style="display: inline;">
                                            <button type="submit" class="btn btn-warning">Edit</button>
                                        </form>

                                        <form action="{{ route('petugas.destroy', $rs->id) }}" method="POST"
